...
# Model 1(1+)&1(1-): transition from hyperparasitism to antiparasitism
...
pdf('Fig4A.pdf',paper="a4r",width=0,height=0)
...
plot(r$t,r$R1,col="green", main="Model 1(1+)&1(1-)", xlab="time", ylab="population size", pch=".", ylim=c(0,6))
points(r$t,r$R2,col="cyan", pch=".")
points(r$t,r$P,col="blue", pch=".")
points(r$t,r$F1,col="pink", pch=".")
points(r$t,r$F2,col="red", pch=".")
legend("topright", c("R1 host ribozyme", "R2 host replicase", "P parasite", "F1 prototemplate", "F2 protoreplicase/antibody"), lty = 1, col = c("green","cyan","blue","red","pink"), box.lwd = 0)
